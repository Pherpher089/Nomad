	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 appendResult116 = (float2(IN.ase_texcoord7.xyz.y , IN.ase_texcoord7.xyz.z));
				...
				float2 appendResult118 = (float2(IN.ase_texcoord7.xyz.x , IN.ase_texcoord7.xyz.z));
				float2 appendResult115 = (float2(IN.ase_texcoord7.xyz.x , IN.ase_texcoord7.xyz.y));
				...
				float2 appendResult61 = (float2(IN.ase_texcoord7.xyz.y , IN.ase_texcoord7.xyz.z));
				float2 appendResult60 = (float2(IN.ase_texcoord7.xyz.x , IN.ase_texcoord7.xyz.z));
				float2 appendResult59 = (float2(IN.ase_texcoord7.xyz.x , IN.ase_texcoord7.xyz.y));
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 appendResult116 = (float2(IN.ase_texcoord2.xyz.y , IN.ase_texcoord2.xyz.z));
				float3 ase_worldNormal = IN.ase_texcoord3.xyz;
				float3 temp_output_43_0 = abs( mul( GetWorldToObjectMatrix(), float4( ase_worldNormal , 0.0 ) ).xyz );
				float dotResult44 = dot( temp_output_43_0 , float3(1,1,1) );
				float3 BlendComponents46 = ( temp_output_43_0 / dotResult44 );
				float2 appendResult118 = (float2(IN.ase_texcoord2.xyz.x , IN.ase_texcoord2.xyz.z));
				float2 appendResult115 = (float2(IN.ase_texcoord2.xyz.x , IN.ase_texcoord2.xyz.y));
				float3 break125 = WorldPosition;
				float2 appendResult129 = (float2(break125.x , break125.z));
				float2 temp_output_154_0 = ( _TilingTop * appendResult129 );
				float bottomTiling149 = _TilingBottom;
				float2 appendResult61 = (float2(IN.ase_texcoord2.xyz.y , IN.ase_texcoord2.xyz.z));
				float2 appendResult60 = (float2(IN.ase_texcoord2.xyz.x , IN.ase_texcoord2.xyz.z));
				float2 appendResult59 = (float2(IN.ase_texcoord2.xyz.x , IN.ase_texcoord2.xyz.y));
				float2 topTiling156 = temp_output_154_0;
...
Node;AmplifyShaderEditor.SamplerNode;65;-2360.381,1891.004;Inherit;True;Property;_TextureSample4;Texture Sample 4;1;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;True;bump;Auto;True;Instance;62;Auto;Texture2D;8;0;SAMPLER2D;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;67;-2360.381,2195.004;Inherit;True;Property;_TextureSample5;Texture Sample 5;1;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;True;bump;Auto;True;Instance;62;Auto;Texture2D;8;0;SAMPLER2D;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;62;-2360.381,1619.004;Inherit;True;Property;_Normal;Normal;1;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;79;-1560.381,2275.004;Inherit;True;Property;_TopNormal;Top Normal;5;0;Create;True;0;0;0;False;0;False;-1;051172491e5bcc64eae95daed11a393a;051172491e5bcc64eae95daed11a393a;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;123;-2213.081,-409.8966;Inherit;True;Property;_TriplanarAlbedo;Triplanar Albedo;0;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;161;-1122.491,74.42596;Inherit;False;Property;_TopColourShift;TopColourShift;7;0;Create;True;0;0;0;False;0;False;1,1,1,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;133;-1055.381,430.0039;Inherit;True;Property;_TopAlbedo;Top Albedo;4;0;Create;True;0;0;0;False;0;False;-1;1fbdf5fdc3a42cd44be2eb882525b937;1fbdf5fdc3a42cd44be2eb882525b937;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;159;-1284.491,-304.574;Inherit;False;Property;_BottomColourShift;BottomColourShift;3;0;Create;True;0;0;0;False;0;False;1,1,1,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=23070FEE04A3FD91127E0B891AB81BBDF1750637