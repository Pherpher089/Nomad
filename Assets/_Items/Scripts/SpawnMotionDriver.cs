...
public class SpawnMotionDriver : MonoBehaviour
{
    ...
    void OnTriggerEnter(Collider other)
    {
        ...
        {
            if (other.tag != "Player" && !other.gameObject.name.Contains("Tree") && !other.gameObject.name.Contains("Grass") && other.GetComponent<SpawnMotionDriver>() == false && other.tag != "DoNotLand" && other.tag != "MainPortal" && other.tag != "Tool" && other.tag != "TheseHands" && (other.tag != "Beast") && other.tag != "Enemy" && other.tag != "InventorySlot")
            {
                Land();
            }
        }
