...
namespace MTAssets.EasyMinimapSystem
{
    ...
    */
    ...
    public class MinimapDataHolder : MonoBehaviour
    {
        ...
        ///<summary>[WARNING] Do not change the value of this variable. This is a variable used for internal tool operations.</summary> 
        [HideInInspector]
        public List<MinimapBackground> instancesOfMinimapBackgroundInThisScene = new List<MinimapBackground>();
        ///<summary>[WARNING] Do not change the value of this variable. This is a variable used for internal tool operations.</summary> 
        [HideInInspector]
        ...
        public class CustomInspector : UnityEditor.Editor
        {
            ...
            private Vector2 minimapBackgroundScrollpos = Vector2.zero;
            ...
            public override void OnInspectorGUI()
            {
                ...
                //Minimap Background
                minimapBackgroundScrollpos = StartDrawListOfInstancesOfComponentHere(minimapBackgroundScrollpos, "Minimap Backgrounds", script.instancesOfMinimapBackgroundInThisScene.Count);
                foreach (MinimapBackground item in script.instancesOfMinimapBackgroundInThisScene)
                    RenderDrawItemOfListOfComponentHere(item);
                FinalizeDrawListOfInstancesOfComponentHere();
