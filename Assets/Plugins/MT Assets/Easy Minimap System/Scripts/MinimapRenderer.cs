    ...
    public class MinimapRenderer : MonoBehaviour
    {
        ...
        public class CustomInspector : UnityEditor.Editor
        {
            ...
            public override void OnInspectorGUI()
            {
                ...
                {
                    script.baseShapeSprite = (Sprite)AssetDatabase.LoadAssetAtPath("Assets/Plugins/MT Assets/Easy Minimap System/Formats/Circle.png", typeof(Sprite));
                ...
                {
                    script.baseShapeSprite = (Sprite)AssetDatabase.LoadAssetAtPath("Assets/Plugins/MT Assets/Easy Minimap System/Formats/Square.png", typeof(Sprite));
                ...
                EditorGUILayout.BeginHorizontal();
                EditorGUILayout.LabelField("Minimap Items For Highlight List", GUILayout.Width(190));
            ...
            public void CreateOrUpdateThePlaceHoldersAppearence(MinimapRenderer script)
            {
                ...
                if (placeHolderBaseObj == null)
                {
                    ...
                    script.baseShapeSprite = (Sprite)AssetDatabase.LoadAssetAtPath("Assets/Plugins/MT Assets/Easy Minimap System/Formats/Circle.png", typeof(Sprite));
                    script.northIconSprite = (Sprite)AssetDatabase.LoadAssetAtPath("Assets/Plugins/MT Assets/Easy Minimap System/Sprites/North0.png", typeof(Sprite));
                }
        ...
        public void ClickWithVirtualCursor()
        {
            //Simulate the event of click
            thisRendererEvents.SimulateOnInputClickEvent();
        }

        public void ClickAndDragVirtualCursor(Vector2 dragAddictionValue)
        {
            //Simulate the event of drag
            thisRendererEvents.SimulateOnInputDragEvent(dragAddictionValue);
        }

        public void MoveVirtualCursor(Vector2 moveAddictionValue)
        {
            //Simulate the event of over
            thisRendererEvents.SimulateOnInputOverEvent(moveAddictionValue);
        }
