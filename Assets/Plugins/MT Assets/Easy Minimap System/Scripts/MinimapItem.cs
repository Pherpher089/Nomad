    ...
    public class MinimapItem : MonoBehaviour
    {
        ...
        public class CustomInspector : UnityEditor.Editor
        {
            ...
            protected virtual void OnSceneGUI()
            {
                ...
                if (script.itemSprite != null)
                {
                    GUI.Box(new Rect(Screen.width - 133, Screen.height - 198, 126, 141), "");
                    GUI.Label(new Rect(Screen.width - 120, Screen.height - 200, 100, 20), "Minimap Item Of", style);
                    GUI.Label(new Rect(Screen.width - 120, Screen.height - 188, 100, 20), "This GameObject", style);
                    GUI.DrawTexture(new Rect(Screen.width - 110, Screen.height - 164, 80, 80), script.itemSprite.texture, ScaleMode.ScaleToFit, true, 1.0f);
                    if (GUI.Button(new Rect(Screen.width - 130, Screen.height - 75, 120, 16), "Select Asset"))
