            ...
            private void EditionToolbar_ShowWorldWaypointEditingTool(MinimapRoutes script)
            {
                ...
                if (script.currentExistingWaypointsItems.Count > 0 && Application.isPlaying == false)
                {
                    ...
                    if (script.showingEditionControls == false)
                        showControlsIcon = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/Plugins/MT Assets/Easy Minimap System/Editor/Images/EyeClose.png", typeof(Texture2D));
                    if (script.showingEditionControls == true)
                        showControlsIcon = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/Plugins/MT Assets/Easy Minimap System/Editor/Images/EyeOpen.png", typeof(Texture2D));
                    Texture2D selectionIcon = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/Plugins/MT Assets/Easy Minimap System/Editor/Images/Selection.png", typeof(Texture2D));
                    Texture2D moveIcon = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/Plugins/MT Assets/Easy Minimap System/Editor/Images/Move.png", typeof(Texture2D));
                    Texture2D createIcon = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/Plugins/MT Assets/Easy Minimap System/Editor/Images/Create.png", typeof(Texture2D));
                    Texture2D deleteIcon = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/Plugins/MT Assets/Easy Minimap System/Editor/Images/Delete.png", typeof(Texture2D));
                    Texture2D connectIcon = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/Plugins/MT Assets/Easy Minimap System/Editor/Images/Connect.png", typeof(Texture2D));
                    Texture2D disconnectIcon = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/Plugins/MT Assets/Easy Minimap System/Editor/Images/Disconnect.png", typeof(Texture2D));
                    Texture2D cutterIcon = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/Plugins/MT Assets/Easy Minimap System/Editor/Images/Cutter.png", typeof(Texture2D));
                    Texture2D aditionalButtonsBg = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/Plugins/MT Assets/Easy Minimap System/Editor/Images/ButtonsBg.png", typeof(Texture2D));
                    Texture2D exportIcon = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/Plugins/MT Assets/Easy Minimap System/Editor/Images/Export.png", typeof(Texture2D));
                    Texture2D importIcon = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/Plugins/MT Assets/Easy Minimap System/Editor/Images/Import.png", typeof(Texture2D));
