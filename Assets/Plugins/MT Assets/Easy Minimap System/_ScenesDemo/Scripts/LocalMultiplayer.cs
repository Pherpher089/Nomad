...
namespace MTAssets.EasyMinimapSystem
{
    public class LocalMultiplayer : MonoBehaviour
    {
        ...
        public void Update()
        {
            ...
            playerRigidbody.linearVelocity = transform.TransformVector(new Vector3(movementAxis.x * movementSpeed, playerRigidbody.linearVelocity.y, movementAxis.z * movementSpeed));
#endif
#if !UNITY_6000_0_OR_NEWER
