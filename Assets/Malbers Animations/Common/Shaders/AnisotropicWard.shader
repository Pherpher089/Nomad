...
Shader "Malbers/Anisotropic/Ward"
{
	Properties
	{
		...
		_Clipping("Clipping", Range( 0 , 1)) = 0.3
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord82 = IN.ase_texcoord8.xy * appendResult85 + float2( 0,0 );
				...
				float3 normalizeResult7 = normalize( ( _WorldSpaceCameraPos - WorldPosition ) );
				...
				float3 normalizeResult79 = normalize( cross( NormalDirection56 , WorldBiTangent ) );
				...
				float3 normalizeResult76 = normalize( cross( NormalDirection56 , WorldTangent ) );
				...
				float3 Albedo = ( tex2DNode1 * _AlbedoTint ).rgb;
				float3 Normal = tex2DNode25;
				float3 Emission = 0;
				float3 Specular = 0.5;
				float Metallic = 0;
				float Smoothness = ( ( tex2D( _Specular, texCoord82 ) * _SpecularTint ) * ( exp( ( ( ( ( HX68 * HX68 ) + ( HY41 * HY41 ) ) / ( NdotH30 + 1.0 ) ) * -2.0 ) ) * max( NdotL27 , 0.0 ) ) ).r;
				float Occlusion = 1;
...
/*ASEBEGIN
Version=18935
51;191;1399;636;2648.789;1813.901;4.202985;True;True
...
Node;AmplifyShaderEditor.ColorNode;59;275.9258,-602.2235;Float;False;Property;_AlbedoTint;Albedo Tint;2;0;Create;True;0;0;0;False;0;False;1,1,1,1;1,0.741725,0.4481131,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;65;269.2042,-95.6257;Float;False;Property;_SpecularTint;Specular Tint;4;0;Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;60;892.8906,-714.4781;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;58;-4477.512,-483.7573;Float;False;Property;_NormalAmount;Normal Amount;6;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;1;235.762,-808.9359;Inherit;True;Property;_Albedo;Albedo;1;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;101;836.925,-252.8693;Inherit;False;Property;_Clipping;Clipping;9;0;Create;True;0;0;0;False;0;False;0.3;0.3;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;39;-1649.396,265.4982;Float;False;Property;_AnisotropyY;Anisotropy Y;8;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;38;-1613.096,9.198168;Float;False;Property;_AnisotropyX;Anisotropy X;7;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector4Node;83;-5104.344,-1005.934;Float;True;Property;_TillingOffset;Tilling & Offset;0;0;Create;True;0;0;0;False;0;False;1,1,0,0;1,1,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;95;6;1;4
WireConnection;95;7;101;0
ASEEND*/
//CHKSM=585C27056155D0CE314D5C5DC0494DE1E9038177