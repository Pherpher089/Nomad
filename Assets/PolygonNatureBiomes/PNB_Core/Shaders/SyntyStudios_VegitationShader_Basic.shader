	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float lerpResult588 = lerp( WorldNormal.y , IN.ase_normal.y , _FrostingWorldObjectSwitch2);
				...
				float4 Albedo78 = ( IN.ase_color.b > 0.5 ? (( _FrostingSwitch )?( lerpResult461 ):( temp_output_73_0 )) : max( blendOpSrc574, blendOpDest574 ) );
				...
				float4 Emissive420 = ( ( IN.ase_color.b > 0.5 ? lerpResult417 : lerpResult569 ) * _EmissiveAmount );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float lerpResult588 = lerp( ase_worldNormal.y , IN.ase_normal.y , _FrostingWorldObjectSwitch2);
				float4 lerpResult461 = lerp( temp_output_73_0 , _FrostingColour , saturate( ( pow( lerpResult588 , _FrostingHeight ) * _FrostingFalloff ) ));
				float4 blendOpSrc574 = (( _FrostingSwitch )?( lerpResult461 ):( temp_output_73_0 ));
				float4 blendOpDest574 = _TrunkBaseColour;
				float4 Albedo78 = ( IN.ase_color.b > 0.5 ? (( _FrostingSwitch )?( lerpResult461 ):( temp_output_73_0 )) : max( blendOpSrc574, blendOpDest574 ) );
...
Node;AmplifyShaderEditor.SamplerNode;70;-4337.806,-354.5892;Inherit;True;Property;_LeafTex;LeafTex;1;1;[Header];Create;True;1;Leaves;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;550;-4331.662,-151.0149;Inherit;True;Property;_TunkTex;TunkTex;6;1;[Header];Create;True;1;Trunk;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;63;-3932.656,208.8435;Inherit;False;Property;_LeafBaseColour;LeafBaseColour;11;1;[Header];Create;True;1;Colour Tinting;0;0;False;0;False;0.07843138,0.02015968,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;218;-2424.936,331.8762;Inherit;False;Property;_TrunkBaseColour;TrunkBaseColour;12;0;Create;True;0;0;0;False;0;False;0.07843138,0.02015968,0,0;0.3301886,0.2648132,0.1884567,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;562;-917.9802,-78.95667;Inherit;True;Property;_TrunkNormalMap;TrunkNormalMap;7;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;0.5;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=BB522864176F0F36B0B0017EAF6017BDC740C82E