...
public class HUDControl : MonoBehaviourPunCallbacks
{
    ...
    public void Initialize()
    {
        ...
        bossHealthBarCanvasObject = transform.GetChild(transform.childCount - 3).gameObject;
        raidCounterCanvasObject = transform.GetChild(transform.childCount - 2).gameObject;
